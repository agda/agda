...
\label{agda}
\report{Nils Anders Danielsson}%05/10
\status{actively developed}
\participants{Ulf Norell, Nils Anders Danielsson, Andreas Abel and
  many others}
\makeheader
...
Since last time version 2.2.8 has been released, with these new
features:
\begin{itemize}
