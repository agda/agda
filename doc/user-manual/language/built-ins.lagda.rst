...
The definitions of builtin types presented in this manual are mainly
those in the ``Agda.Builtin`` modules, but they might not match
hand-rolled builtin types. See, for instance,
