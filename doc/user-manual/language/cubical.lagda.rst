...
The option :option:`--cubical-without-glue` enables a variant of Cubical
Agda in which Glue (and the other builtins defined in
``Agda.Builtin.Cubical.Glue``) are disabled,
thus allowing path equalities but not univalence, for example.
