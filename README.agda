...
-- Foster, Liyang Hu, Patrik Jansson, Alan Jeffrey, Evgeny Kotelnikov,
-- Eric Mertens, Darin Morrison, Guilhem Moulin, Shin-Cheng Mu, Ulf
-- Norell, Noriyuki OHKAWA, Nicolas Pouillard, Andrés Sicard-Ramírez
-- and Noam Zeilberger.
------------------------------------------------------------------------
