...
\cite{dowek:matching,elliott:matching,pym}, but we will give a novel approach to the treatment of meta 
variables where well-typedness of substitutions is guaranteed. To ensure type correctness the type checker 
