...
\Rules{Simplify guards}{
	...
	\Sigma ~ = ~ \Ext {\Sigma_1} \Ext {\ConstDecl p A M \Cs} {\Sigma_2} \\
	\ExplicitJudgement {\Sigma_1} {\Cs \leadsto {\Cs^\prime}} {\Sigma^\prime_1} \\
    \end{array}
    }
\\{}\\
    \infer{
	\ExplicitJudgement \Sigma \SolveConstraints {\Sigma''}
    }{\begin{array}{lll}
	\ExplicitJudgement \Sigma \SolveConstraints {\Sigma'}
    &	\Sigma \neq \Sigma'
    &	\ExplicitJudgement {\Sigma'} \SolveConstraints {\Sigma''}
