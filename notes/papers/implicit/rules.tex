...
The basic idea is to work with well-typed approximations of terms. An
approximation of a term is obtained by replacing a subterm by a fresh constant
of the appropriate type.

% introduce new constants for potentially ill-typed terms.  
...
\Rules{Check that a term is well-scoped relative to a meta variable}{
	...
	\Sigma ~=~ \Ext {\Sigma_1} \Ext {\MetaDecl \alpha A} \Sigma_2
    \\	\exists \, \Gamma, B. ~ \HasTypeCS {\Sigma_1} \Gamma M B
    \end{array}
    }
}
...
\TODO{change to Conor style zipping?}
...
\TODO{move rules talking about pattern matching here.}
