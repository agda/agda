...
We introduce four operations to manipulate meta variables: $\AddMeta \alpha A$
adds a new meta variable $\alpha$ of type $A$ to the signature, $\InstMeta
\alpha M$ instantiates $\alpha$ to $M$, $\LookupMeta \alpha M$ looks up the
