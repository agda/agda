...
ifeq ("3.0","$(word 1,$(sort 3.0 $(CABAL_VERSION)))")
	CABAL_BUILD_CMD=new-build
	CABAL_CLEAN_CMD=new-clean
	CABAL_CONFIGURE_CMD=new-configure
	CABAL_HADDOCK_CMD=new-haddock
	CABAL_INSTALL_CMD=new-install
	CABAL_OLD_BUILD_CMD=v1-build
	CABAL_OLD_INSTALL_CMD=v1-install
	CABAL_OLD_CONFIGURE_CMD=v1-configure
else ifeq ("2.4","$(word 1,$(sort 2.4 $(CABAL_VERSION)))")
