...
install-lib :
	$(CABAL_CMD) install -f epic --disable-library-profiling --disable-documentation $(CABAL_OPTIONS)

install-prof-lib :
	$(CABAL_CMD) install -f epic --enable-library-profiling --disable-documentation $(CABAL_OPTIONS)
