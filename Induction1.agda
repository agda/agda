...
SubsetRecursorBuilder : forall {a} -> Pred a -> RecStruct a -> Set2
SubsetRecursorBuilder {a} Q Rec =
  (P : Pred a) -> Rec P ⊆ P -> Q ⊆ Rec P

SubsetRecursor : forall {a} -> Pred a -> RecStruct a -> Set2
