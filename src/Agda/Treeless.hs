...
data Range' = Range' deriving (Eq, Show, Ord)
noRange = Range'
data QName = QName deriving (Eq, Show, Ord)
data Literal = LitNat Range' Integer deriving (Eq, Show, Ord)
