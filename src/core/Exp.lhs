...
We use deBruijn indexes for representing functional expressions. The abstract syntax of expressions is given by the following:
...
--  evalBody is used in Decl when typechecking an implicitly defined constant.
