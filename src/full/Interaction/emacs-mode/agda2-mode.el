...
(let ((l
       '(
         ...
         (agda2-solveAll                           "\C-c\C-="      "Solve constraints"                           )
         ...
         (agda2-text-state                         "\C-c\C-x\C-t"  "Text state"                                  )
         (agda2-display-implicit-arguments         "\C-c\C-i"      "Toggle display of _i_mplicit arguments"      )
         (agda2-highlight-reload-or-clear          "\C-c\C-s"      "Reload _s_yntax highlighting information"    )
