...
(let ((l
       `(
         ...
         (agda2-display-implicit-arguments         "\C-c\C-x\C-h"   "Toggle display of _h_idden arguments"        )
         (agda2-highlight-reload-or-clear          "\C-c\C-x\C-s"   "Reload _s_yntax highlighting information"    )
         ...
         (agda2-next-goal                          "\C-c\C-f"       "Next goal (_f_orward)"                       )
         (agda2-previous-goal                      "\C-c\C-b"       "Previous goal (_b_ack)"                      )
         (agda2-undo                               "\C-c\C-u"       "Undo"                                        )
         (agda2-undo                               "\C-_"           "Undo"                                        )
         (agda2-infer-type-maybe-toplevel          nil              "Infer type (TAB is C-i)"                     )
         ...
         (agda2-give                               "\C-c\C-h"       nil "Give (fill _h_ole)"                      )
         (agda2-refine                             "\C-c\C-r"       nil "Refine"                                  )
         (agda2-make-case                          "\C-c\C-c"       nil "Case"                                    )
         (agda2-goal-type                          "\C-c\C-t"       nil "Goal _t_ype"                             )
         (agda2-goal-type-normalised               nil              nil "Goal type (normalised)"                  )
         (agda2-show-context                       "\C-c\C-e"       nil "Context (_e_nvironment)"                 )
         (agda2-show-context-normalised            nil              nil "Context (normalised)"                    )
         (agda2-infer-type-maybe-toplevel          "\C-c\C-i"       nil "_I_nfer type (TAB is C-i)"               )
         ...
         (agda2-compute-normalised-maybe-toplevel  "\C-c\C-n"       nil "Compute _n_ormal form"                   )
         (agda2-indent                [tab])
