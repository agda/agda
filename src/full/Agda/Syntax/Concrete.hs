...
data Expr
  ...
  | QuotePostponedTerm Range                   -- ^ ex: @quotePostponedTerm@, should be applied to a term
...
instance KillRange Expr where
  ...
  killRange (QuotePostponedTerm _) = QuoteTerm noRange
