...
module Agda.Syntax.Parser
    ...
    , parseFile
      -- * Parse flags
    , Agda.Syntax.Parser.Monad.ParseFlags(..)
    , Agda.Syntax.Parser.Monad.defaultParseFlags
      -- * Parsers
    , moduleParser
    , moduleNameParser
    , acceptableFileExts
...
import qualified Agda.Syntax.Parser.Monad
...
moduleParser :: ParseFlags -> Parser Module
moduleParser f = Parser
  { parser        = P.moduleParser
  , parseFlags    = withoutComments f
  , parseLiterate = parseLiterateWithoutComments
  }

-- | Parses a module name.

moduleNameParser :: ParseFlags -> Parser QName
moduleNameParser f = Parser
...
exprParser :: ParseFlags -> Parser Expr
exprParser f = Parser
  { parser        = P.exprParser
  , parseFlags    = withoutComments f
  , parseLiterate = parseLiterateWithoutComments
...
exprWhereParser :: ParseFlags -> Parser ExprWhere
exprWhereParser f = Parser
...
holeContentParser :: ParseFlags -> Parser HoleContent
holeContentParser f = Parser
...
tokensParser :: ParseFlags -> Parser [Token]
tokensParser f = Parser
  { parser        = P.tokensParser
  , parseFlags    = withComments f
  , parseLiterate = parseLiterateWithComments
  }

-- | Keep comments in the token stream generated by the lexer.

withComments :: ParseFlags -> ParseFlags
withComments f = f { parseKeepComments = True }

-- | Do not keep comments in the token stream generated by the lexer.

withoutComments :: ParseFlags -> ParseFlags
withoutComments f = f { parseKeepComments = False }
