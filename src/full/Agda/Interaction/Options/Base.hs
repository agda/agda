...
infectiveCoinfectiveOptions =
  ...
  , infectiveOption optFunext                 "--funext"
  , infectiveOption optPropext                "--propext"
  , infectiveOption optQuotients              "--quotients"
  ]
  where
  cubicalCompatible =
...
modalityPragmaOptions = ("Modalities",) $ concat
  ...
  , pragmaFlag      "occurrence-analysis" lensOptOccurrence
                    ...
                    "(can be slow)"
                    Nothing
  , pragmaFlag      "funext" lensOptFunext
                    "allow the use of Agda.Builtin.Funext" ""
                    Nothing
  , pragmaFlag      "propext" lensOptPropext
                    "allow the use of Agda.Builtin.Propext" ""
                    Nothing
  , pragmaFlag      "quotients" lensOptQuotients
                    "allow the use of Agda.Builtin.Quotient" ""
                    Nothing
