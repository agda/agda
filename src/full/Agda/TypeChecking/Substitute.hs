...
instance Apply Definition where
  apply (Defn info x t pol occ gens gnum gpars df m c inst copy ma nc inj copat blk lang d) args =
    Defn info x (piApply t args) (apply pol args) (apply occ args) (apply gens args) gnum (drop (length args) gpars) df m c inst copy ma nc inj copat blk lang (apply d args)
...
instance Abstract Definition where
  abstract tel (Defn info x t pol occ gens gnum gpars df m c inst copy ma nc inj copat blk lang d) =
    Defn info x (abstract tel t) (abstract tel pol) (abstract tel occ) (abstract tel gens) gnum
