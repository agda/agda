...
data PersistentTCState = PersistentTCSt
  ...
  , stPersistentFileDict :: !FileDictBuilder
...
lensFileDict :: Lens' PersistentTCState FileDictBuilder
lensFileDict f s = f (stPersistentFileDict s) <&> \ x -> s { stPersistentFileDict = x }
...
stFileDict = lensPersistentState . lensFileDict
