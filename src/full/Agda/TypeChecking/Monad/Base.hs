...
instance KillRange Defn where
  killRange def =
    case def of
      ...
      Function cls comp ct tt inv mut isAbs delayed proj flags term extlam with copat ->
        killRange14 Function cls comp ct tt inv mut isAbs delayed proj flags term extlam with copat
