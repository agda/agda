...
data TCState =
    TCSt { stFreshThings       :: FreshThings
         ...
         , stDirty               :: Bool -- local
           ...
           -- Currently unused.
         , stOccursCheckDefs   :: Set QName -- local
         ...
         , stImports           :: Signature  -- XX populated by scopec hecker
           -- ^ Imported declared identifiers.
           --   Those most not be serialized!
         , stImportedModules   :: Set ModuleName  -- imports logic
         , stModuleToSource    :: ModuleToSource   -- imports
         , stVisitedModules    :: VisitedModules   -- imports
...
data PersistentTCState = PersistentTCSt
  ...
  , stCachedState :: !(Maybe (CachedState, CachedState))
