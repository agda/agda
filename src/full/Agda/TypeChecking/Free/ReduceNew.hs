...
{-# OPTIONS_GHC -Wno-unused-imports -Wno-redundant-bang-patterns #-}
...
module Agda.TypeChecking.Free.ReduceNew
  ( ForceNotFree
  , forceNotFree
  , reallyFree
  , IsFree(..)
...
reduceIfFreeVars k = \a -> do
  ...
  -- traceM "RFFVARS-NEW"
  -- traceShowM (locals, xs, fvs, noFreeInPrecomputed locals xs fvs)
