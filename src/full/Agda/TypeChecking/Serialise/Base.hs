...
data Dict = Dict
  ...
  , naturalD     :: !(HashTable Natural Word32)    -- ^ Written to interface file.
...
data St = St
  ...
  , naturalE  :: !(Array Word32 Natural)  -- ^ Obtained from interface file.
...
-- its five uses: Integer, Natural, String, Double, Node.
