...
instance EmbPrj Interface where
  icod_ (Interface a b c d e f g h i j k l m n o p q r s t u v w) =
      icodeN' interface a b c (fromImportedModules d) e f g h i j k l m n o p q r s t u v w
    where interface a b c = Interface a b c . toImportedModules

  value = vcase valu where
    valu [a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w] =
        valuN interface a b c d e f g h i j k l m n o p q r s t u v w
      where interface a b c = Interface a b c . toImportedModules
    valu _ = malformed
