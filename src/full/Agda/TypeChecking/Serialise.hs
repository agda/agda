...
currentInterfaceVersion = 20121008 * 10 + 0
...
instance EmbPrj Defn where
  ...
  icode (Function    a spt b c d e f g h)       = icode8 1 a b c d e f g h
  ...
  value = vcase valu where
    valu [0]                                    = valu0 Axiom
    valu [1, a, b, c, d, e, f, g, h]            = valu8 (\ a -> Function a Nothing) a b c d e f g h
