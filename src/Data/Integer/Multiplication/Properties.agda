------------------------------------------------------------------------
-- Some properties about multiplication on integers
------------------------------------------------------------------------

module Data.Integer.Multiplication.Properties where

open import Algebra using (module CommutativeSemiring; CommutativeMonoid)
import Algebra.FunctionProperties
open import Algebra.Structures using (IsSemigroup; IsCommutativeMonoid)
open import Data.Product using (proj₂)
open import Data.Integer
   using (ℤ; -[1+_]; +_; ∣_∣; sign; _◃_)
   renaming (_*_ to ℤ*)
open import Data.Nat using (suc; zero) renaming (_+_ to _ℕ+_; _*_ to _ℕ*_)
...
private
  ...
  assoc x y (+ zero) rewrite proj₂ *-zero ∣ y ∣
                           | proj₂ *-zero ∣ x ∣
