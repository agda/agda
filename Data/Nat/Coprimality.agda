...
Coprime : (m n : ℕ) -> Set
Coprime m n = forall {i} -> i Divides m And n -> i ≡ 1

-- Coprime numbers have 1 as their gcd.

coprime-gcd : forall {m n} -> Coprime m n -> GCD m n 1
...
gcd-coprime : forall {m n} -> GCD m n 1 -> Coprime m n
