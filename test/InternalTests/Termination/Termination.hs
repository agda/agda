...
module InternalTests.Termination.Termination ( tests ) where
...
import InternalTests.Helpers -- hiding (idempotent)
...
tests :: IO Bool
tests = runTests "InternalTests.Termination.Termination"
