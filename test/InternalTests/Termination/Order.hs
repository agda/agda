...
module InternalTests.Termination.Order ( tests ) where

import Agda.Termination.CutOff
import Agda.Termination.Order

import InternalTests.Helpers
import qualified InternalTests.Termination.Semiring as Semiring
...
tests :: IO Bool
tests = runTests "InternalTests.Termination.Order"
