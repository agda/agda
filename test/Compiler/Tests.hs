...
disabledTests =
  ...
  , RFInclude "Compiler/JS/simple/Arith"
  , RFInclude "Compiler/JS/simple/BuiltinInt"
  ...
  , RFInclude "Compiler/JS/simple/FlexibleInterpreter"
  ...
  , RFInclude "Compiler/JS/simple/Forcing4"
  , RFInclude "Compiler/JS/simple/InlineRecursive"
  , RFInclude "Compiler/JS/simple/Irrelevant"
  , RFInclude "Compiler/JS/simple/Issue1441"
  , RFInclude "Compiler/JS/simple/Issue1486"
  , RFInclude "Compiler/JS/simple/Issue1624"
  , RFInclude "Compiler/JS/simple/Issue326"
  , RFInclude "Compiler/JS/simple/Issue727"
  , RFInclude "Compiler/JS/simple/Literals"
  , RFInclude "Compiler/JS/simple/ModuleArgs"
  , RFInclude "Compiler/JS/simple/ModuleReexport"
  , RFInclude "Compiler/JS/simple/NoRecordConstructor"
  , RFInclude "Compiler/JS/simple/Records"
  , RFInclude "Compiler/JS/simple/Sort"
  , RFInclude "Compiler/JS/simple/StaticPatternLambda"
  , RFInclude "Compiler/JS/simple/TrailingImplicits"
  , RFInclude "Compiler/JS/simple/UnusedArguments"
  , RFInclude "Compiler/JS/simple/VaryingClauseArity"
  , RFInclude "Compiler/JS/simple/VecReverse"
  , RFInclude "Compiler/JS/simple/VecReverseIrr"
  , RFInclude "Compiler/JS/simple/WfRec"
  ]
