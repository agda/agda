{-# OPTIONS --safe --erased-quotients --hidden-argument-puns #-}
...
opaque
  ...
  -- The proof of this lemma is probably based on Voevodsky's work on
...
_ :
  {@0 prop : Is-proposition B}
  {f : A → B} →
  trec (id prop) f x ≡ trec prop f (id x)
_ = refl
