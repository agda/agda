...
\\
\>\AgdaKeyword{open} \AgdaModule{List1} \AgdaKeyword{using} \AgdaSymbol{(}\AgdaField{first}\AgdaSymbol{;} \AgdaField{tail}\AgdaSymbol{)}\<%
\\
%
\\
...
\\
\>\AgdaKeyword{open} \AgdaModule{List1} \AgdaSymbol{(}\AgdaInductiveConstructor{trivial} \AgdaInductiveConstructor{∷} \AgdaInductiveConstructor{[]}\AgdaSymbol{)} \AgdaKeyword{using} \AgdaSymbol{(}tail\AgdaSymbol{)}\<%
\\
%
\\
