-- Andreas, 2026-09-04, issue #3027, internall error due to unsolved constraints.
-- Report and test case by Ulf Norell on 2018-04-11.
-- This issue was fixed in Agda 2.6.4.
...
-- WAS: internal error
-- Expected error for constr₂: [UnequalTerms]
-- The terms
--   f false 1
-- and
--   zero
-- are not equal at type Nat
-- when checking that the expression refl has type ?X 1 ≡ D 0
