...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaPostulate{Size} \<[9]%
\>[9]\AgdaSymbol{:} \AgdaPrimitiveType{Set}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaPostulate{Size<\_} \AgdaSymbol{:} \AgdaPostulate{Size} \AgdaSymbol{→} \AgdaPrimitiveType{Set}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaPostulate{↑\_} \<[9]%
\>[9]\AgdaSymbol{:} \AgdaPostulate{Size} \AgdaSymbol{→} \AgdaPostulate{Size}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaPostulate{∞} \<[9]%
\>[9]\AgdaSymbol{:} \AgdaPostulate{Size}\<%
\\
%
\\
...
\>[31]\AgdaSymbol{((\_} ∷ \AgdaBound{l}\AgdaSymbol{)} \AgdaInductiveConstructor{,} \AgdaBound{s′}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaBound{step} \AgdaBound{s}\<%
\\
\>[2]\AgdaIndent{26}{}\<[26]%
